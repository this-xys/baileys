...
const baileysVersion = [2, 3e3, 1043857760];
...
const unixTimestampSeconds = (date = new Date()) => date.getTime() / 1e3 | 0;
...
const fetchLatestBaileysVersion = async (options = {}) => {
  const URL = "https://unpkg.com/@whiskeysockets/baileys@latest/lib/Defaults/index.js";
  try {
