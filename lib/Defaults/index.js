...
}, shouldIgnoreJid: () => false, linkPreviewImageThumbnailWidth: 192, transactionOpts: { maxCommitRetries: 10, delayBetweenTriesMs: 3e3 }, eventBufferTimeoutMs: 3e4, statusBroadcastDelayMs: 1500, albumDelayMs: 1500, phashRetryEnabled: false, generateHighQualityLinkPreview: false, enableAutoSessionRecreation: true, enableRecentMessageCache: true, options: {}, appStateMacVerification: { patch: false, snapshot: false }, countryCode: "US", getMessage: async () => void 0, cachedGroupMetadata: async () => void 0, makeSignalRepository: makeLibSignalRepository, useNativeCrypto: false };
